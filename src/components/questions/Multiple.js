...
export default class Multiple extends React.Component {
    ...
    handleChange = (event) => {
        ...
        this.setState({ id: this.props.content, value: value, answer: this.props.answer }, () => {
        ...
        return (
            <div className="form-group">
                ...
                <div className="form-check">
                    <input className="form-check-input" type="radio" name={`questionRadios${this.props.id}`} id={`questionRadios1${this.props.id}`} value="radio1" onChange={this.handleChange} required />
                ...
                <div className="form-check">
                    <input className="form-check-input" type="radio" name={`questionRadios${this.props.id}`} id={`questionRadios2${this.props.id}`} value="radio2" onChange={this.handleChange} required />
                ...
                <div className="form-check">
                    <input className="form-check-input" type="radio" name={`questionRadios${this.props.id}`} id={`questionRadios3${this.props.id}`} value="radio3" onChange={this.handleChange} required />
