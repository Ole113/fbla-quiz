            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                ...
                <ul className="navbar-nav ml-auto">
                    <li className="nav-item nav-item-help">
                        { /* The help menu button that when clicked the function HIDE_BUTTON is called */}
                        <button type="button" className="modal-button" data-toggle="modal" data-target="#helpModal" >
                            <img onClick={HIDE_BUTTON} className="nav-link" src={props.color === "dark" ? require("../assets/images/helpDark.svg").default : require("../assets/images/helpWhite.svg").default} alt="question mark icon" />
                        </button>
                    </li>
                </ul>
            </div>
